          ...
          <div id="header">
            <div id="logo_birds">
              <div id="logo_container">
                <div id="logo"><img src="images/logo.png" width="262" height="64" alt="Logo" /></div>
              </div>
              <div class="left"></div>
              <div class="right"></div>
            </div>
            <!--end logo birds-->
            <div id="search_blimp">
              <div class="front"><img src="images/search_blimp.png" width="213" height="63" alt="Search" /></div>
              <div class="middle">
                <div class="button">
                  <input name="search_button" type="image" src="images/button_search.gif"/>
                </div>
                <div class="field">
          ...
          <div id="menu_wrapper">
            <div id="main_menu">
              <ul>
                ...
                <li><a href="product_full.html">product full</a></li>
          ...
          <div id="container">
            ...
            <div id="content">
              ...
              <ul>
                  ...
                  Kids Toys                  </a></li>
                                <li><a href="product_full.html">
                  Product Full Description                  </a></li>
                                <li><a href="products.html">
                  Products                  </a></li>
                                <li><a href="terms_faq.html">
                  Terms &amp; Faq                  </a></li>
                              </ul>
              <!--end site map code-->
              <hr class="clear" />
